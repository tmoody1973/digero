...
- **SECTION_NAME** = [Human-readable name, e.g., "Recipe Library" or "Meal Planner"]
- **SECTION_ID** = [Folder name in sections/, e.g., "recipe-library" or "meal-planner"]
- **NN** = [Milestone number, e.g., "02" or "03" — sections start at 02 since 01 is Foundation]

---

I need you to implement the **SECTION_NAME** section of my recipe app.
