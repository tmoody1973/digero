import type { LoadedClerk, PhoneCodeChannel, SessionResource, SignUpModes, SignUpResource } from '@clerk/shared/types';
 ...
 */
export declare function handleCombinedFlowTransfer({ identifierAttribute, identifierValue, signUpMode, navigate, organizationTicket, afterSignUpUrl, clerk, handleError, redirectUrl, redirectUrlComplete, passwordEnabled, navigateOnSetActive, alternativePhoneCodeChannel, unsafeMetadata, }: HandleCombinedFlowTransferProps): Promise<unknown> | void;
